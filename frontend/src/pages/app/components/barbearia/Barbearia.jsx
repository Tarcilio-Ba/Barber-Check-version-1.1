...
export default class Barbearia extends Component {
    ...
    save = async () => {
        ...
        if (!nome || !email || !endereco || !telefone) {
            ...
            try {
                await api.post("/barbearias", { nome, email, endereco, telefone, Codemp })
    ...
    render() {
        return (
            <Main {...headerProps} >
                <NavLink className="btn btn-info" activeClassName="selected" to="/barbearias" >
                    Listar Barbearias
                </NavLink>
